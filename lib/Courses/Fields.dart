    ...
    return SingleChildScrollView(
      ...
      children: [
        InkWell(
          ...
          child: const CardNav(
          title:"Computer Science", subtitle:"4",
          color:Color.fromARGB(255, 78, 194, 212), 
          buttonText:'Add a subject', type:'course', course_type: 'Cs',),
        ),
        InkWell(
          onTap: () {
            Navigator.push(
          ...
          child:const CardNav(
            title:"Mathematics", subtitle:"4",
            color:Color.fromARGB(255, 78, 194, 212), 
            buttonText:'Add a subject', type:'course', course_type: 'Mth',),
        ),
        InkWell(
          onTap: () {
            Navigator.push(
          ...
          child: const CardNav(
            title:"Statistics", subtitle:"4",
            color:Color.fromARGB(255, 78, 194, 212), 
            buttonText:'Add a subject', type:'course', course_type: 'Stc',),
        ),
        InkWell(
          onTap: () {
            Navigator.push(
          ...
          child: const CardNav(
            title:"Business & Entrepreneurship", subtitle:"4",
            color:Color.fromARGB(255, 78, 194, 212),  
            buttonText:'Add a subject', type:'course', course_type: 'BE',),
        ),
        InkWell(
          onTap: () {
            Navigator.push(
          ...
          child: const CardNav(
            title:"English", subtitle:"4",
            color:Color.fromARGB(255, 78, 194, 212),
            buttonText:'Add a subject', type:'course', course_type: 'Eng',),
        ),
        InkWell(
          onTap: () {
            Navigator.push(
          ...
          child: const CardNav(
            title:"Organizational Psychology", subtitle:"4",
            color:Color.fromARGB(255, 78, 194, 212),
            buttonText:'Add a subject', type:'course', course_type: 'OP',),
        ),
      ],
    ));
  }
